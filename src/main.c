...
int main() {
	...
	docker_process_list_container(ctx,
			id, //"7460166eeca46468a217d3fb058924f07bebb674a3502fa1b0440cd933cfc9ff",
			NULL);
	...
	docker_containers_list* containers = docker_container_list(ctx, 1, 5, 1,
			filter);
