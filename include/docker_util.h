 ...
 *
 * @param p pair to create and return
...
/**
 * @brief Parse the iso date time from given string
 * 
 * @param date_str input date string
 * @param tm output time object
 */
MODULE_API void parse_iso_datetime(char* date_str, struct tm* tm);

/**
 * @brief Parse the docker stats read time from the given string
 * 
 * @param date_str input date string
 * @param tm output time object
 */
